...
Row {.tabset .tabset-fade .tabset-pills data-height="650"}
-----------------------------------------------------------------------
...
cartosportreg <- sp::merge(regwgs,sportreg,by="REG")
...
"treemap", hcaes(x=fede, group = REG, value=round(value,1) ),
  ...
  hc_subtitle(text="Le football représente près du <b>quart</b> des licences unisport olympiques") %>%
...
"treemap",hcaes(x=fede, group = REG, value=round(value,1) ),
       color = c("#1a6ecc70", "#90ed7d60" )  )%>%
  hc_subtitle(text="<b>1/5e</b> des  unisport non olympique en pétanque, <b>1/6e</b> en randonnée") %>%
  hc_legend(title=list(text="Clic pour voir France ou BFC" )) %>%
  hc_add_theme(thm) ,
...
"treemap",hcaes(x=fede, group = REG, value=round(value,1) ),
       color = c("#1a6ecc70", "#90ed7d60" )  )%>%
    hc_subtitle(text="Près d'un <b>quart</b> des licences multisport en UNSS") %>%
  hc_legend(title=list(text="Clic pour voir France ou BFC" )) %>%
  hc_add_theme(thm) ,
