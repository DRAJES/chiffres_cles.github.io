...
ACMH(data = ACMHreg_ensemble, lignes = c(5:17,4,1) )
...
ACMH(data = ACMHreg_vacances,lignes = c(5:17,4,1))
...
ACMH(data = ACMHreg_courts,lignes = c(5:17,4,1))
...
ACMH(data = ACMHreg_specifiques,lignes = c(5:17,4,1))
...
ACMH(data = ACMHreg_accessoires,lignes = c(5:17,4,1))

```


## Row {data-height="20"} Données départementales
...
ACMH(data = ACMHdep_ensemble,lignes = as.numeric(depbfc)+5 )
...
ACMH(data = ACMHreg_vacances,lignes = as.numeric(depbfc)+5)
...
ACMH(data = ACMHreg_courts,lignes = as.numeric(depbfc)+5)
...
ACMH(data = ACMHreg_specifiques,lignes = as.numeric(depbfc)+5)
...
ACMH(data = ACMHreg_accessoires,lignes = as.numeric(depbfc)+5)
