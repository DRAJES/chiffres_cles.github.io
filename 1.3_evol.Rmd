...
```{r,echo=F}
load("C:/Users/plebre/Documents/projets R/DRAJES/data/demo/spark.RData")
library(sparkline)
sparkline(0)
region_tab %>%
  ...
  mutate(" "= if_else(substr(str_split_fixed(region_tab$`évolution annuelle`,"<*>",3)[,2],1,4)   < 0,
                 cell_spec('![](C:/Users/plebre/Documents/projets R/DRAJES/images/arrow-down-right.svg)',
                           color="red") ,
                 cell_spec('![](C:/Users/plebre/Documents/projets R/DRAJES/images/arrow-up-right.svg)',
                           color="green")
                 ) ) %>%
  relocate(" ",.after=`évolution annuelle`) %>%
