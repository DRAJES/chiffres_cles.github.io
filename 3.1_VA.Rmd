...
-   En novembre 2022, la Bourgogne-Franche-Comté compte **117 000** associations selon le Répertoire National des Associations (RNA).

-   C'est la **troisième** région de France en nombre d'association par habitant derrière la Corse et l'Occitanie, **9e** région française en nombre d'associations

-   Les associations sportives représentent près du quart des associations (plus grande proportion de France).


    -   Si le répertoire est exhaustif, il est en revanche peu actualisé, en particulier pour les associations qui ont peu d'activité ou ne font pas de demande de subvention. On estime à un peu plus de la moitié les associations véritablement actives (entre **60 000 et 65 000** dans la région, sans clé de répartition).
...
L'emploi associatif est particulièrement développé en **Haute-Saône**. Plus d'un emploi salarié privé sur six relève du secteur associatif. 

*voir synthèse 0.1 pour une représentation graphique*
