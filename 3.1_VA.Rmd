...
appartenance <- rbind(appartenance,c("REG","FM","France Métro","-"))
...
carte <-   leaflet(RNAcarto) %>%  
    addPolygons(data=RNAcarto,group  = "régions",
                ...
                fillColor = ~pal(100*RNAcarto$total/RNAcarto$pop),fillOpacity  = 0.8,
    ...
    addMinicharts(centroid(RNAcarto)[,1],centroid(RNAcarto)[,2] ,
                  ...
                  opacity = 0.7) %>%
    addLegend( pal = pal ,values = 100*(RNAcarto$total/RNAcarto$pop),
