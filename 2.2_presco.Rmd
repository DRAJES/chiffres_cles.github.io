...
load("C:/Users/plebre/Documents/projets R/DRAJES/data/jeunesse/PMI.RData")
...
#pal3 <- colorBin("YlOrBr", domain =0:100 ,bins= c(0, 5,7.5, 10,12.5, 15,20, 100) )
...
leaflet(cartereg) %>%   addProviderTiles(providers$Wikimedia) %>% 
...
leaflet(cartedep) %>% addProviderTiles(providers$Wikimedia) %>% 
