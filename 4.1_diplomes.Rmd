...
# Diplômes professionnels {data-orientation="rows" height="30" data-icon="fa-graduation-cap" .storyboard}
...
```
***
**`r prettyNum(round(diplreg[14,3]/100,0)*100,big.mark = " ")`** diplômes des professions du sport et de l'animation délivrés en 2019 dont la moitié en STAPS. **8e** région de France en nombre de diplômes délivrés. La moitié des diplômes sont issus de la filière STAPS.
...
# Diplômes non professionnels (BAFA/BAFD) {data-orientation="rows" height="30" data-icon="fa-users" .storyboard}
...
# Insertion des diplômés {data-orientation="rows" height="30" data-icon="fa-user-tie" .storyboard}
