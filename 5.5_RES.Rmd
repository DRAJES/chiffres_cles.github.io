...
leaflet(res) %>% 
  ...
  addPolygons(fill = TRUE, fillOpacity = 0.6, fillColor = ~pal(txequi), smoothFactor = 2,
   ...
   addPolygons(fill = TRUE, fillOpacity = 0.6, fillColor = ~pal(50000*structurant/pop.y), smoothFactor = 2,
              weight = 2, opacity = 0.6, color = "#2F4F4F",
              popup = popupTable(res@data %>% 
                                   select(NOM,`nb équipements`=equ,Population=pop.y,
                                          `Tx équipements`=txequi,
   ...
   addPolygons(fill = TRUE, fillOpacity = 0.6, fillColor = ~pal(50000*gdsjeux/pop.y), smoothFactor = 2,
              weight = 2, opacity = 0.6, color = "#2F4F4F",
              popup = popupTable(res@data %>% 
                                   select(NOM,`nb équipements`=equ,Population=pop.y,
                                          `Tx équipements`=txequi,
    ...
    addPolygons(fill = TRUE, fillOpacity = 0.6, fillColor = ~pal(50000*proxi/pop.y), smoothFactor = 2,
              weight = 2, opacity = 0.6, color = "#2F4F4F",
              popup = popupTable(res@data %>% 
                                   select(NOM,`nb équipements`=equ,Population=pop.y,
                                          `Tx équipements`=txequi,
   ...
   addPolygons(fill = TRUE, fillOpacity = 0.6, fillColor = ~pal(400000*bassins/pop.y), smoothFactor = 2,
              weight = 2, opacity = 0.6, color = "#2F4F4F",
              popup = popupTable(res@data %>% 
                                   select(NOM,`nb équipements`=equ,Population=pop.y,
                                          `Tx équipements`=txequi,
...
hchart( equip %>% filter(!is.na(DEP)) %>% group_by(DEP) %>% summarise(equ=n() ) %>%
         ...
         bind_rows(equip %>% filter(REG=="27") %>%group_by(REG) %>%
                     summarise(equ=n()) %>%
