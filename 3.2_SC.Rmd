...
**3 100** missions de service civique en Bourgogne-Franche-Comté en 2022.  
**3 000** volontaires originaires de la région.  
Des missions tournées principalement vers l'éducation pour tous et la solidarité.
```{r}
#créer des value box pour les données au dessus
```
...
```
***
**Une large majorité de femmes parmi les volontaires, près d'un tiers de peu diplômés, 30% étaient chômeurs auparavant, un contrat sur cinq rompu avant son terme dont 9% pour embauche.**
...
flux de nouveaux volontaires par année](https://pierre-stephanelebre.shinyapps.io/fluxSC/)
...
# Engagement international {data-orientation="rows" data-icon="fa-globe-africa" .storyboard}
...
# `r fa(name = "fas fa-city")` Quartier politique de la ville {data-orientation="rows" .storyboard}
...
```
***
**Environ un jeune de 16 à 25 ans sur 100 s'engage dans une mission de Service civique, y compris dans les QPV, presque un volontaire sur cinq issus de quartier prioritaire dans le Territoire de Belfort et le Doubs.**
