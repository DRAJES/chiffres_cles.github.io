...
# ![](images/BFC_s.svg) Régions {data-orientation="rows" height="20" .storyboard}
...
# ![](images/BFC_dep_s.svg) Départements {data-orientation="rows" height="20" .storyboard}
...
# ![](images/BFC_EPCI_s.svg) EPCI {data-orientation="rows" height="20" .storyboard}
...
***
Comparaison des établissements publics de comparaison intercommunale
...
Sélectionnez un ou plusieurs départements pour voir les territoires correspondant
...
# ![](images/BFC_BV_s.svg) Bassins de vie {data-orientation="rows" height="20" .storyboard}
...
Comparaison des bassins de vie 2022
...
# `r fa(name = "fas fa-layer-group")` Découpages administratifs {data-orientation="rows" height="20" .storyboard}
...
# `r fa(name = "fas fa-tree")` CRTE {data-orientation="rows" height="20" .storyboard}
