...
load("C:/Users/plebre/Documents/projets R/DRAJES/data/demo/CRTE.RData")
...
# ![](C:/Users/plebre/Documents/projets%20R/DRAJES/images/BFC_s.svg) Régions {data-orientation="rows" height="20"}
...
# ![](C:/Users/plebre/Documents/projets%20R/DRAJES/images/BFC_dep_s.svg) Départements {data-orientation="rows" height="20"}
...
**Sous-couche de grille de densité en fond de carte**
...
# ![](C:/Users/plebre/Documents/projets%20R/DRAJES/images/BFC_EPCI_s.svg) EPCI {data-orientation="rows" height="20"}
...
# ![](C:/Users/plebre/Documents/projets%20R/DRAJES/images/BFC_BV_s.svg) Bassins de vie {data-orientation="rows" height="20"}
...
```{r}
leaflet() %>% 
  addProviderTiles(providers$OpenStreetMap.France, group="OSM") %>%
  addProviderTiles(providers$OpenTopoMap, group="Topo") %>%
  addProviderTiles(providers$GeoportailFrance.orthos, group="Geoportail") %>%
  addProviderTiles(providers$GeoportailFrance.maps, group="Geoportail.maps") %>%
  ...
  #addProviderTiles(providers$WaymarkedTrails_riding , group="rando") %>%
  addProviderTiles(providers$Thunderforest.OpenCycleMap, group="vélo") %>%
 ...
 # addPolygons(data=ZRR, group  = "ZRR",fill = T,fillOpacity = 0.4,fillColor = "#6B8E23", stroke=F,weight = 1) %>%
  ...
  addPolygons(data=dep27carto,group  = "départements",fill = F,color="#9370DB",weight = 3,opacity = 1) %>%
addLayersControl(
    baseGroups = c("OSM","Topo","Geoportail","Geoportail.maps","wikimedia","NASA", "hydro"),
    overlayGroups = c("rando","vélo","routes","safecast"),
